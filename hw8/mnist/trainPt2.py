...
h_conv1 = conv_nn_layer(x_image, 5, 5, 1, 16, 'hidden1')

# Describe 2nd convolutional neural network
h_conv2 = conv_nn_layer(h_conv1, 5, 5, 16, 32, 'hidden2')
#with tf.name_scope('pool1'):
#    h_pool1 = max_pool_2x2(h_conv2)

# Descibe 3rd convolutional neural network
h_conv3 = conv_nn_layer(h_conv2, 5, 5, 32, 64, 'hidden3')
#with tf.name_scope('pool2'):
#    h_pool2 = max_pool_2x2(h_conv3)

# Describe 1st fully-connected layer
h_flat = tf.reshape(h_conv3, [-1, 28*28*64])
h_fc1 = fc_nn_layer(h_flat, 28*28*64, 1024, 'hidden4') 
